/**
 * Depenses Notification Panel
 * Panneau de notifications pour Depenses
 */
...
interface DepensesNotificationPanelProps {
  isOpen: boolean;
  onClose: () => void;
}

export function DepensesNotificationPanel({ isOpen, onClose }: DepensesNotificationPanelProps) {
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: '1',
      type: 'urgent',
      title: 'Notification urgente',
      message: 'Exemple de notification urgente pour Depenses',
