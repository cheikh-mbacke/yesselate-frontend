/**
 * Navigation secondaire pour Analytics
 * Breadcrumb et sous-onglets - inspiré de la page Gouvernance
 */
...
export const AnalyticsSubNavigation = React.memo(function AnalyticsSubNavigation({
  mainCategory,
  mainCategoryLabel,
  subCategory,
  subCategories,
