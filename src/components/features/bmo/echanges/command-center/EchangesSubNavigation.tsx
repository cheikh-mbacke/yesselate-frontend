/**
 * Navigation secondaire pour Échanges Inter-Bureaux
...
interface EchangesSubNavigationProps {
  mainCategory: string;
...
export const EchangesSubNavigation = React.memo(function EchangesSubNavigation({
  mainCategory,
  mainCategoryLabel,
  subCategory,
  subCategories,
