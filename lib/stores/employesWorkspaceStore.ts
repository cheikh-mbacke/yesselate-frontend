...
// Types
// ================================
export type EmployeTabType = 'inbox' | 'employe' | 'evaluation' | 'competences' | 'wizard' | 'stats';

export interface EmployeTab {
  id: string;
  type: EmployeTabType;
  title: string;
  icon: string;
...
interface EmployesWorkspaceState {
  ...
  openTab: (tab: EmployeTab) => void;
  closeTab: (id: string) => void;
  setActiveTab: (id: string) => void;
  updateTab: (id: string, updates: Partial<EmployeTab>) => void;
  closeAllTabs: () => void;
...
export const useEmployesWorkspaceStore = create<EmployesWorkspaceState>()(
  persist(
    (set, get) => ({
      ...
      updateTab: (id: string, updates: Partial<EmployeTab>) => {
        set((state) => ({
