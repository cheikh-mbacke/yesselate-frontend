/**
 * Imports Notification Panel
 * Panneau de notifications pour Imports
 */
...
interface ImportsNotificationPanelProps {
  isOpen: boolean;
  onClose: () => void;
}

export function ImportsNotificationPanel({ isOpen, onClose }: ImportsNotificationPanelProps) {
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: '1',
      type: 'urgent',
      title: 'Notification urgente',
      message: 'Exemple de notification urgente pour Imports',
