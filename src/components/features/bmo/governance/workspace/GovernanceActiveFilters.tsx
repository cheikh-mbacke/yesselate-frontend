/**
 * Composant de filtres actifs (chips) pour la gouvernance
 * Affiche les filtres appliqués sous forme de badges amovibles
 */
...
interface GovernanceActiveFiltersProps {
  filters: ActiveFilter[];
  onClearAll?: () => void;
  className?: string;
}

export function GovernanceActiveFilters({
  filters,
  onClearAll,
  className,
}: GovernanceActiveFiltersProps) {
