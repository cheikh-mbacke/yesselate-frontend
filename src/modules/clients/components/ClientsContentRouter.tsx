/**
 * Router de contenu pour le module Clients
 */
...
interface ClientsContentRouterProps {
  mainCategory: ClientsMainCategory;
  subCategory?: string;
  subSubCategory?: string;
}

export function ClientsContentRouter({
  mainCategory,
  subCategory,
  subSubCategory,
}: ClientsContentRouterProps) {
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-slate-400 mb-4">
        Navigation 3 niveaux activée. Le contenu sera géré par le ClientsContentRouter existant.
      </p>
