...
// Types
// ================================
export type DelegationTabType = 'inbox' | 'delegation' | 'wizard' | 'validation' | 'historique';

export interface DelegationTab {
  id: string;
...
interface DelegationWorkspaceState {
  ...
  openTab: (tab: DelegationTab) => void;
  closeTab: (id: string) => void;
  setActiveTab: (id: string) => void;
  updateTab: (id: string, updates: Partial<DelegationTab>) => void;
  closeAllTabs: () => void;
...
// Store
// ================================
export const useDelegationWorkspaceStore = create<DelegationWorkspaceState>()(
  persist(
    (set, get) => ({
      // Tabs
      tabs: [],
      ...
      updateTab: (id: string, updates: Partial<DelegationTab>) => {
        set((state) => ({
