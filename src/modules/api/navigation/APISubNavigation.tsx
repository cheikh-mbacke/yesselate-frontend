/**
 * Navigation secondaire et tertiaire pour le module API
 */
...
import { apiNavigationConfig, getSubCategories, getSubSubCategories, type NavNode } from './apiNavigationConfig';
import type { APIMainCategory } from '../types/apiNavigationTypes';

interface APISubNavigationProps {
...
export function APISubNavigation({ mainCategory, subCategory, subSubCategory, onSubCategoryChange, onSubSubCategoryChange, stats = {} }: APISubNavigationProps) {
  const subCategories = getSubCategories(mainCategory);
  const subSubCategories = subCategory ? getSubSubCategories(mainCategory, subCategory) : [];
  const mainLabel = apiNavigationConfig[mainCategory]?.label || 'API';
