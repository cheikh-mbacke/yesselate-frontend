/**
 * Projets Notification Panel
 * Panneau de notifications pour Projets
 */
...
interface ProjetsNotificationPanelProps {
  isOpen: boolean;
  onClose: () => void;
}

export function ProjetsNotificationPanel({ isOpen, onClose }: ProjetsNotificationPanelProps) {
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: '1',
      type: 'urgent',
      title: 'Notification urgente',
      message: 'Exemple de notification urgente pour Projets',
