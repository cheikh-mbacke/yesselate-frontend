/**
 * Page Réunions projets / chantiers
 */
...
export function ReunionsProjetsPage() {
  ...
  return (
    <div className="flex flex-col h-full w-full">
      <CalendarHeader breadcrumb={['Calendrier', 'Événements & Réunions', 'Réunions projets / chantiers']} />
      <div className="flex-1 overflow-auto p-6">
        <div className="max-w-7xl mx-auto space-y-4">
          <div className="flex items-center gap-2 mb-4">
            <Users className="h-5 w-5 text-blue-400" />
            <h2 className="text-xl font-semibold text-slate-200">
              Réunions projets / chantiers ({evenements.length})
            </h2>
          </div>

          {evenements.length === 0 ? (
            <div className="text-center py-12 text-slate-400">
              Aucune réunion projet/chantier
            </div>
          ) : (
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="font-semibold text-slate-200">{event.titre || 'Événement'}</span>
                      {event.chantier_id && (
