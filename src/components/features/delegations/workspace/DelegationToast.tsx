/**
 * Système de notifications toast pour les délégations
...
export function useDelegationToast() {
  ...
  if (!context) {
    throw new Error('useDelegationToast must be used within DelegationToastProvider');
  }
  return context;
}

export function DelegationToastProvider({ children }: { children: React.ReactNode }) {
