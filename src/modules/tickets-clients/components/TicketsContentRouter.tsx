/**
 * Router de contenu pour le module Tickets-Clients
 */
...
export function TicketsContentRouter({
  mainCategory,
  subCategory,
  subSubCategory,
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-slate-400 mb-4">
        Navigation 3 niveaux activée. Le contenu sera géré par le TicketsContentRouter existant.
      </p>
