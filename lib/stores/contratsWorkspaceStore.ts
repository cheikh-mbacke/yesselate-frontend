...
// Types
// ================================
export type ContratTabType = 'inbox' | 'contrat' | 'validation' | 'avenant' | 'wizard' | 'historique';
...
interface ContratsWorkspaceState {
  ...
  openTab: (tab: ContratTab) => void;
  closeTab: (id: string) => void;
  setActiveTab: (id: string) => void;
  updateTab: (id: string, updates: Partial<ContratTab>) => void;
  closeAllTabs: () => void;
...
export const useContratsWorkspaceStore = create<ContratsWorkspaceState>()(
  persist(
    (set, get) => ({
      ...
      updateTab: (id: string, updates: Partial<ContratTab>) => {
        set((state) => ({
