/**
 * Navigation secondaire pour Validation Contrats
 * Breadcrumb et sous-onglets - inspiré de AnalyticsSubNavigation
 */
...
interface ValidationContratsSubNavigationProps {
  mainCategory: string;
...
export function ValidationContratsSubNavigation({
  mainCategory,
  mainCategoryLabel,
  subCategory,
  subCategories,
  ...
  activeFilter = null,
  onFilterChange,
}: ValidationContratsSubNavigationProps) {
