/**
 * Menu d'actions consolidé pour Échanges Inter-Bureaux
...
interface EchangesActionsMenuProps {
  onRefresh?: () => void;
  isRefreshing?: boolean;
  onFilters?: () => void;
}

export function EchangesActionsMenu({ onRefresh, isRefreshing, onFilters }: EchangesActionsMenuProps) {
  const {
    fullscreen,
    toggleFullscreen,
