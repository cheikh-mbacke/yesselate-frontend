/**
 * Router de contenu pour le module Finances
 */
...
interface FinancesContentRouterProps {
  mainCategory: FinancesMainCategory;
  subCategory?: string;
  subSubCategory?: string;
}

export function FinancesContentRouter({
  mainCategory,
  subCategory,
  subSubCategory,
}: FinancesContentRouterProps) {
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-slate-400 mb-4">
        Navigation 3 niveaux activée. Le contenu sera géré par le FinancesContentRouter existant.
      </p>
