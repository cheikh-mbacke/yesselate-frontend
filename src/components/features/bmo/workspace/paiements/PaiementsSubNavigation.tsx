/**
 * Navigation secondaire pour Validation Paiements
 * Breadcrumb et sous-onglets - inspiré d'Analytics et Gouvernance
 */
...
export const PaiementsSubNavigation = React.memo(function PaiementsSubNavigation({
  mainCategory,
  mainCategoryLabel,
  subCategory,
  subCategories,
