/**
 * Navigation secondaire et tertiaire pour le module Calendrier
...
export function CalendrierSubNavigation({
  mainCategory,
  subCategory,
  subSubCategory,
  onSubCategoryChange,
  ...
  const mainLabel = calendrierNavigationConfig3Levels[mainCategory]?.label || 'Calendrier';
                ...
                {badge !== undefined && (
                  <Badge
                    ...
                    className={cn(
                      ...
                      badgeType === 'success' && 'bg-emerald-500/20 text-emerald-400 border-emerald-500/30',
