/**
 * Finances Notification Panel
 * Panneau de notifications pour Finances
 */
...
interface FinancesNotificationPanelProps {
  isOpen: boolean;
  onClose: () => void;
}

export function FinancesNotificationPanel({ isOpen, onClose }: FinancesNotificationPanelProps) {
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: '1',
      type: 'urgent',
      title: 'Notification urgente',
      message: 'Exemple de notification urgente pour Finances',
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-1">
                      ...
                      {!notif.read && <div className="w-2 h-2 rounded-full bg-emerald-400 flex-shrink-0 mt-1" />}
                    </div>
