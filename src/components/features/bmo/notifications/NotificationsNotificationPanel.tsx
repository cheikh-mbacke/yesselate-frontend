 ...
 * Panneau de notifications pour Notifications
 */
...
interface NotificationsNotificationPanelProps {
  isOpen: boolean;
  onClose: () => void;
}

export function NotificationsNotificationPanel({ isOpen, onClose }: NotificationsNotificationPanelProps) {
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: '1',
      type: 'urgent',
      title: 'Notification urgente',
      message: 'Exemple de notification urgente pour Notifications',
