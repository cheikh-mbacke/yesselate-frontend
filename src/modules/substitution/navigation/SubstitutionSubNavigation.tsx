/**
 * Navigation secondaire et tertiaire pour le module Substitution
 */
...
import {
  substitutionNavigationConfig,
  getSubCategories,
  getSubSubCategories,
  type NavNode,
} from './substitutionNavigationConfig';
...
export function SubstitutionSubNavigation({
  mainCategory,
  subCategory,
  subSubCategory,
  onSubCategoryChange,
  ...
  stats = {},
}: SubstitutionSubNavigationProps) {
  const subCategories = getSubCategories(mainCategory);
  const subSubCategories = subCategory ? getSubSubCategories(mainCategory, subCategory) : [];

  const mainLabel = substitutionNavigationConfig[mainCategory]?.label || 'Substitution';
