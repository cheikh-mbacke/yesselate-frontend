/**
 * Router de contenu pour le module Employes
 */
...
interface EmployesContentRouterProps {
  mainCategory: EmployesMainCategory;
  subCategory?: string;
  subSubCategory?: string;
}

export function EmployesContentRouter({
  mainCategory,
  subCategory,
  subSubCategory,
}: EmployesContentRouterProps) {
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-slate-400 mb-4">
        Navigation 3 niveaux activée. Le contenu sera géré par le EmployesContentRouter existant.
      </p>
