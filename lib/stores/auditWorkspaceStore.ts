...
// Types
// ================================
export type AuditTabType = 'inbox' | 'event' | 'timeline' | 'analysis' | 'report' | 'stats';
...
interface AuditWorkspaceState {
  ...
  openTab: (tab: AuditTab) => void;
  closeTab: (id: string) => void;
  setActiveTab: (id: string) => void;
  updateTab: (id: string, updates: Partial<AuditTab>) => void;
  closeAllTabs: () => void;
...
export const useAuditWorkspaceStore = create<AuditWorkspaceState>()(
  persist(
    (set, get) => ({
      ...
      updateTab: (id: string, updates: Partial<AuditTab>) => {
        set((state) => ({
