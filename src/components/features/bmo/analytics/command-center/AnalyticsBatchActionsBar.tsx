/**
 * Barre d'actions groupées pour Analytics
 * Apparaît quand des éléments sont sélectionnés (KPIs, Alertes, Rapports)
 */
...
export function AnalyticsBatchActionsBar({
  onAction,
  actions = defaultActions,
}: BatchActionsBarProps) {
  const { selectedItems, clearSelection } = useAnalyticsCommandCenterStore();
