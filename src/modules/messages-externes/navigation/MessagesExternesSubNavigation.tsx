/**
 * Navigation secondaire et tertiaire pour le module Messages Externes
 */
...
import { messagesExternesNavigationConfig, getSubCategories, getSubSubCategories, type NavNode } from './messagesExternesNavigationConfig';
...
export function MessagesExternesSubNavigation({ mainCategory, subCategory, subSubCategory, onSubCategoryChange, onSubSubCategoryChange, stats = {} }: MessagesExternesSubNavigationProps) {
  const subCategories = getSubCategories(mainCategory);
  const subSubCategories = subCategory ? getSubSubCategories(mainCategory, subCategory) : [];
  const mainLabel = messagesExternesNavigationConfig[mainCategory]?.label || 'Messages';
