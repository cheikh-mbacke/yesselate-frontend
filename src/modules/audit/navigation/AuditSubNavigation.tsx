/**
 * Navigation secondaire et tertiaire pour le module Audit
 */
...
import { auditNavigationConfig, getSubCategories, getSubSubCategories, type NavNode } from './auditNavigationConfig';
...
export function AuditSubNavigation({ mainCategory, subCategory, subSubCategory, onSubCategoryChange, onSubSubCategoryChange, stats = {} }: AuditSubNavigationProps) {
  const subCategories = getSubCategories(mainCategory);
  const subSubCategories = subCategory ? getSubSubCategories(mainCategory, subCategory) : [];
  const mainLabel = auditNavigationConfig[mainCategory]?.label || 'Audit';
