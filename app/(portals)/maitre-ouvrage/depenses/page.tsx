 ...
 * Les demandes de dépenses sont maintenant un onglet
...
export default function DepensesPage() {
  ...
  useEffect(() => {
    // Redirection vers demandes-rh avec le filtre dépenses
    router.replace('/maitre-ouvrage/demandes-rh?tab=depenses');
  }, [router]);
