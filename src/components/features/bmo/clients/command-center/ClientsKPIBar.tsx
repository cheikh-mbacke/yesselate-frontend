/**
 * Barre de KPIs en temps réel pour Clients
...
const mockKPIs: KPIItem[] = [
  {
    ...
    trendValue: '+8',
    status: 'success',
    sparkline: [140, 142, 145, 148, 150, 154, 156],
  },
  {
    id: 'prospects',
    label: 'Prospects',
...
export const ClientsKPIBar = React.memo(function ClientsKPIBar({
  visible = true,
  collapsed = false,
  onToggleCollapse,
  onRefresh,
      ...
      <div className="flex items-center justify-between px-4 py-1.5 border-b border-slate-800/50">
        <div className="flex items-center gap-3">
          <span className="text-xs font-medium text-slate-400 uppercase tracking-wide">
            Indicateurs clients en temps réel
          </span>
