/**
 * Design Tokens
 * Système de design tokens pour la cohérence visuelle
 */
...
/**
 * Fonction helper pour obtenir un espacement
 */
...
/**
 * Fonction helper pour obtenir un border radius
 */
...
/**
 * Fonction helper pour obtenir une ombre
 */
