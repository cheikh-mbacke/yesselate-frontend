 ...
 * Panneau de notifications pour Maintenance
 */
...
interface MaintenanceNotificationPanelProps {
  isOpen: boolean;
  onClose: () => void;
}

export function MaintenanceNotificationPanel({ isOpen, onClose }: MaintenanceNotificationPanelProps) {
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: '1',
      type: 'urgent',
      title: 'Notification urgente',
      message: 'Exemple de notification urgente pour Maintenance',
