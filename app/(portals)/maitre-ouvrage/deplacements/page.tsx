 ...
 * Les demandes de déplacements sont maintenant un onglet
...
export default function DeplacementsPage() {
  ...
  useEffect(() => {
    // Redirection vers demandes-rh avec le filtre déplacements
    router.replace('/maitre-ouvrage/demandes-rh?tab=deplacements');
  }, [router]);
