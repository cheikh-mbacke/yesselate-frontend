...
// Types
// ================================
export type RecouvrementTabType = 'inbox' | 'creance' | 'relance' | 'historique' | 'wizard' | 'stats';
...
interface RecouvrementsWorkspaceState {
  ...
  openTab: (tab: RecouvrementTab) => void;
  closeTab: (id: string) => void;
  setActiveTab: (id: string) => void;
  updateTab: (id: string, updates: Partial<RecouvrementTab>) => void;
  closeAllTabs: () => void;
...
export const useRecouvrementsWorkspaceStore = create<RecouvrementsWorkspaceState>()(
  persist(
    (set, get) => ({
      ...
      updateTab: (id: string, updates: Partial<RecouvrementTab>) => {
        set((state) => ({
    ...
    {
      name: 'bmo-recouvrements-workspace',
      partialize: (state) => ({
