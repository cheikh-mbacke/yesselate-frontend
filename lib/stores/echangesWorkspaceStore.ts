...
// Types
// ================================
export type EchangeTabType = 'inbox' | 'echange' | 'thread' | 'archive' | 'wizard' | 'stats';

export interface EchangeTab {
  id: string;
  type: EchangeTabType;
  title: string;
  icon: string;
...
interface EchangesWorkspaceState {
  ...
  openTab: (tab: EchangeTab) => void;
  closeTab: (id: string) => void;
  setActiveTab: (id: string) => void;
  updateTab: (id: string, updates: Partial<EchangeTab>) => void;
  closeAllTabs: () => void;
...
export const useEchangesWorkspaceStore = create<EchangesWorkspaceState>()(
  persist(
    (set, get) => ({
      ...
      updateTab: (id: string, updates: Partial<EchangeTab>) => {
        set((state) => ({
