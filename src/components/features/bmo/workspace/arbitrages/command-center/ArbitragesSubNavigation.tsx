/**
 * Navigation secondaire pour Arbitrages & Goulots
 * Breadcrumb et sous-onglets - Architecture Command Center v3.0
 */
...
export const ArbitragesSubNavigation = React.memo(function ArbitragesSubNavigation({
  mainCategory,
  mainCategoryLabel,
  subCategory,
  subCategories,
  ...
  return (
    <div className="bg-slate-900/60 border-b border-slate-700/50">
      ...
      <div className="px-4 py-2 flex items-center gap-2 text-sm border-b border-slate-800/50">
        <span className="text-slate-500">Arbitrages</span>
