/**
 * Garanties Notification Panel
 * Panneau de notifications pour Garanties
 */
...
interface GarantiesNotificationPanelProps {
  isOpen: boolean;
  onClose: () => void;
}

export function GarantiesNotificationPanel({ isOpen, onClose }: GarantiesNotificationPanelProps) {
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: '1',
      type: 'urgent',
      title: 'Notification urgente',
      message: 'Exemple de notification urgente pour Garanties',
