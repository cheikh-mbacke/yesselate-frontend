...
// Types
// ================================
export type PaiementTabType = 'inbox' | 'paiement' | 'validation' | 'historique' | 'wizard';
...
interface PaiementsWorkspaceState {
  ...
  openTab: (tab: PaiementTab) => void;
  closeTab: (id: string) => void;
  setActiveTab: (id: string) => void;
  updateTab: (id: string, updates: Partial<PaiementTab>) => void;
  closeAllTabs: () => void;
...
export const usePaiementsWorkspaceStore = create<PaiementsWorkspaceState>()(
  persist(
    (set, get) => ({
      ...
      updateTab: (id: string, updates: Partial<PaiementTab>) => {
        set((state) => ({
