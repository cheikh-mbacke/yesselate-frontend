/**
 * Navigation secondaire et tertiaire pour le module Projets-en-Cours
 */
...
import {
  projetsNavigationConfig,
  getSubCategories,
  getSubSubCategories,
  type NavNode,
} from './projetsNavigationConfig';
...
export function ProjetsSubNavigation({
  ...
  const mainLabel = projetsNavigationConfig[mainCategory]?.label || 'Projets';
