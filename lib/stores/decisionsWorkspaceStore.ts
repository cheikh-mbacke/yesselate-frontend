...
// Types
// ================================
export type DecisionTabType = 'inbox' | 'decision' | 'comite' | 'validation' | 'wizard' | 'stats';

export interface DecisionTab {
  id: string;
  type: DecisionTabType;
  title: string;
  icon: string;
...
interface DecisionsWorkspaceState {
  ...
  openTab: (tab: DecisionTab) => void;
  closeTab: (id: string) => void;
  setActiveTab: (id: string) => void;
  updateTab: (id: string, updates: Partial<DecisionTab>) => void;
  closeAllTabs: () => void;
...
export const useDecisionsWorkspaceStore = create<DecisionsWorkspaceState>()(
  persist(
    (set, get) => ({
      ...
      updateTab: (id: string, updates: Partial<DecisionTab>) => {
        set((state) => ({
