/**
 * Rapports Notification Panel
 * Panneau de notifications pour Rapports
 */
...
interface RapportsNotificationPanelProps {
  isOpen: boolean;
  onClose: () => void;
}

export function RapportsNotificationPanel({ isOpen, onClose }: RapportsNotificationPanelProps) {
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: '1',
      type: 'urgent',
      title: 'Notification urgente',
      message: 'Exemple de notification urgente pour Rapports',
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-1">
                      ...
                      {!notif.read && <div className="w-2 h-2 rounded-full bg-blue-400 flex-shrink-0 mt-1" />}
                    </div>
