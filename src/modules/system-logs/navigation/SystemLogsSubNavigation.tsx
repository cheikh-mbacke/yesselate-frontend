/**
 * Navigation secondaire et tertiaire pour le module System Logs
 */
...
import { systemLogsNavigationConfig, getSubCategories, getSubSubCategories, type NavNode } from './systemLogsNavigationConfig';
import type { SystemLogsMainCategory } from '../types/systemLogsNavigationTypes';

interface SystemLogsSubNavigationProps {
...
export function SystemLogsSubNavigation({ mainCategory, subCategory, subSubCategory, onSubCategoryChange, onSubSubCategoryChange, stats = {} }: SystemLogsSubNavigationProps) {
  const subCategories = getSubCategories(mainCategory);
  const subSubCategories = subCategory ? getSubSubCategories(mainCategory, subCategory) : [];
  const mainLabel = systemLogsNavigationConfig[mainCategory]?.label || 'System Logs';
