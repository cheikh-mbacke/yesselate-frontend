  ...
  try {
    ...
    const allAlerts = [
      ...
      },
      {
        ...
        type: 'warning',
        category: 'performance',
        title: 'Délai moyen élevé - RÉSOLU',
        description: 'Le délai moyen était de 4 jours, maintenant réduit à 2.5 jours',
        metric: 'Délai moyen',
        currentValue: 2.5,
        targetValue: 3,
        unit: 'jours',
      ...
      },
      {
        ...
        type: 'warning',
        category: 'financier',
        title: 'Dépassement budgétaire - RÉSOLU',
        description: 'Le budget était dépassé, maintenant sous contrôle',
        metric: 'Budget consommé',
        currentValue: 78,
        targetValue: 80,
        unit: '%',
