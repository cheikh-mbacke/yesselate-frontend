/**
 * Audits Notification Panel
 * Panneau de notifications pour Audits
 */
...
interface AuditsNotificationPanelProps {
  isOpen: boolean;
  onClose: () => void;
}

export function AuditsNotificationPanel({ isOpen, onClose }: AuditsNotificationPanelProps) {
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: '1',
      type: 'urgent',
      title: 'Notification urgente',
      message: 'Exemple de notification urgente pour Audits',
