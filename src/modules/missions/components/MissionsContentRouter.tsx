/**
 * Router de contenu pour le module Missions
 */
...
export function MissionsContentRouter({
  mainCategory,
  subCategory,
  subSubCategory,
}: MissionsContentRouterProps) {
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-slate-400 mb-4">
        Navigation 3 niveaux activée. Le contenu sera géré par le MissionsContentRouter existant.
      </p>
