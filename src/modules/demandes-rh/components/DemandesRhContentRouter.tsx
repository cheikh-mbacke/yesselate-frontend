/**
 * Router de contenu pour le module DemandesRH
 */
...
interface DemandesRhContentRouterProps {
  mainCategory: DemandesRhMainCategory;
  subCategory?: string;
  subSubCategory?: string;
}

export function DemandesRhContentRouter({
  mainCategory,
  subCategory,
  subSubCategory,
}: DemandesRhContentRouterProps) {
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-slate-400 mb-4">
        Navigation 3 niveaux activée. Le contenu sera géré par le DemandesRhContentRouter existant.
      </p>
