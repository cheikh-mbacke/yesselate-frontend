/**
 * Navigation secondaire et tertiaire pour le module Logs
 */
...
import { logsNavigationConfig, getSubCategories, getSubSubCategories, type NavNode } from './logsNavigationConfig';
import type { LogsMainCategory } from '../types/logsNavigationTypes';

interface LogsSubNavigationProps {
...
export function LogsSubNavigation({ mainCategory, subCategory, subSubCategory, onSubCategoryChange, onSubSubCategoryChange, stats = {} }: LogsSubNavigationProps) {
  const subCategories = getSubCategories(mainCategory);
  const subSubCategories = subCategory ? getSubSubCategories(mainCategory, subCategory) : [];
  const mainLabel = logsNavigationConfig[mainCategory]?.label || 'Logs';
