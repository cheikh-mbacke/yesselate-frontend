/**
 * Sidebar de navigation pour le module Tickets-Clients
 */
...
import { ChevronDown, ChevronRight, ChevronLeft, Search, Ticket } from 'lucide-react';
import { ticketsNavigationConfig, type NavNode } from './ticketsNavigationConfig';
    ...
    return (
      <div className="w-16 h-full bg-slate-900/80 border-r border-slate-800 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-2 space-y-1">
          {Object.values(ticketsNavigationConfig).map((node) => {
            const Icon = node.icon;
