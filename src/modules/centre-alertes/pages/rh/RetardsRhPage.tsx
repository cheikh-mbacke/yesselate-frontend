...
export function RetardsRhPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-slate-200 mb-1">Retards RH</h2>
        <p className="text-sm text-slate-400">
          Liste des retards dans les processus RH
        </p>
      </div>
